...
app.kubernetes.io/name: {{ include "wordsmith.name" . }}
...
*/}}
{{- define "wordsmith.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "wordsmith.fullname" .) .Values.serviceAccount.name }}
{{- else }}
